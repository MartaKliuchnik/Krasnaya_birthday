...
const compliments: Array<ComplimentType> = [
	{
		name: 'Уверенности',
		description:
			'Пусть глаза твои всегда сияют радостью, пусть твоё женское очарование не знает преград и бьёт наповал, без пощады и предупреждения!',
		image: image1,
	},
	{
		name: 'Везения',
	...
	},
	{
		name: 'Удовлетворения',
		description:
			'Пусть дело, которым ты занимаешься, приносит не только хорошую зарплату, но и максимальное творческое удовлетворение! Пусть на пути будет меньше преград и больше возможностей!',
		image: image5,
	},
	{
		name: 'Решительности',
	...
	},
	{
		name: 'Мечтай',
		description:
			'Желаю мечтать сколько угодно, и чтоб не треснула губа! Жить сладкой жизнью, и чтоб нигде ничего не слиплось! Удовлетворяй все желания веселых тараканов в твоей голове!',
		image: image7,
	},
];
